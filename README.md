...
## Возможности пользователей 
 ...
 - Поставщик (Связь с сущностями "Товар" с типом связи - many to many, "Организация" ; "ИП" , "Паспорт" и "UserRole" с типом свзяи - one to one)
   ...
   5. Статус (ID_Org, ID_IP) - описание того, кем является пользователь: продавцом в организации или ИП (тип: varchar(32) ; ограничение: обязательное поле для выборки, внешний ключ)
   ...
   8. ID_Passport - внешний ключ (тип: int(16))
 ...
 - Заказчик (Связь с сущностями "Заказ" и "UserRole" с типом связи - one to many, "Паспорт" и "UserRole" с типом свзяи - one to one)
   ...
   7. ID_Passport - внешний ключ (тип: int(16))
 ...
 - Log_Post
   1. ID_LogPost - уникальный индификатор, первичный ключ (тип: int(16); ограничение: обязательное поле)
   2. ID_Post - уникальный индификатор, внешний ключ (тип: int(16); ограничение: обязательное поле)
 ...
 - Log_Zakazchik
   1. ID_LogZak - уникальный индификатор, первичный ключ (тип: int(16); ограничение: обязательное поле)
